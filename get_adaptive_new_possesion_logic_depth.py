...
# video_path = "/mnt/SamsungSSD/Prtljaga/photoshop_videji/overlap_over_luggage2.mp4"
# video_path = "/mnt/SamsungSSD/Prtljaga/photoshop_videji/2_person_1_leaves.mp4"
# video_path = "/mnt/SamsungSSD/Prtljaga/dataset_aboda/ABODA-master/video1.avi"
# video_path = "/mnt/SamsungSSD/Prtljaga/photoshop_videji/1_person_abanonding.mp4"
...
while cap.isOpened():
    ...
    for res in results:
        if res.boxes and res.boxes.id is not None:
            for box in res.boxes:
                ...
                color = color_mapping.get(cls, (0,255,255))
                label = f"{name} ({obj_id})"
    ...
    cv2.imshow("Depth-Aware YOLOv8 Abandonment Detection", annotator.result())
